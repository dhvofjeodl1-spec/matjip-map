...
const sections = [
  {
    title: '서비스 소개',
    body: '맛집맵은 지역 맛집을 지도 위에서 쉽게 찾고, 등록하고, 확인할 수 있는 베타 서비스입니다.',
  },
  {
    title: '맛집 등록 방법',
    body: '지도에서 원하는 위치를 선택하고 맛집 정보를 입력하면 관리자의 승인 후 공개됩니다.',
  },
  {
    title: '승인 시스템',
    body: '등록된 맛집은 관리자 승인 후 지도에 노출되어 더 신뢰성 있는 정보를 제공합니다.',
  },
  {
    title: '운영 원칙',
    body: '정확한 정보와 안전한 이용을 위해 잘못된 정보는 신고 기능으로 알려주세요.',
  },
  {
    title: 'FAQ',
    body: '로그인 없이도 둘러볼 수 있지만, 등록·신고 기능은 로그인 후 이용할 수 있습니다.',
  },
];
    ...
    <div className="min-h-screen bg-gray-50 px-4 py-6 text-gray-800 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-4xl flex-col gap-4">
        ...
        <div className="rounded-[24px] border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <h1 className="mt-2 text-2xl font-bold">맛집맵 소개</h1>
          <p className="mt-3 text-sm leading-7 text-gray-600">
            맛집맵은 지도에서 맛집을 발견하고, 직접 등록하며, 신뢰할 수 있는 정보를 공유하는 서비스입니다.
          </p>
        </div>
