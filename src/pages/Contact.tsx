...
const items = [
  {
    title: '문의하기',
    description: '서비스 이용 관련 문의를 남겨주세요.',
    icon: Mail,
    href: 'mailto:dhvofjeodl1@gmail.com',
  },
  {
    title: '버그 제보',
    description: '지도 오류나 화면 문제를 알려주세요.',
    icon: Bug,
    href: 'mailto:dhvofjeodl1@gmail.com?subject=버그%20제보',
  },
  {
    title: '삭제 요청',
    description: '부적절한 정보나 잘못된 맛집 등록을 요청하세요.',
    icon: Trash2,
    href: 'mailto:dhvofjeodl1@gmail.com?subject=삭제%20요청',
  },
  {
    title: '서비스 제안',
    description: '새 기능이나 개선 아이디어를 공유해주세요.',
    icon: Sparkles,
    href: 'mailto:dhvofjeodl1@gmail.com?subject=서비스%20제안',
  },
];
    ...
    <div className="min-h-screen bg-gray-50 px-4 py-6 text-gray-800 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-4xl flex-col gap-4">
        ...
        <div className="rounded-[24px] border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <h1 className="mt-2 text-2xl font-bold">맛집맵 문의</h1>
          <p className="mt-3 text-sm leading-7 text-gray-600">
            운영팀으로 바로 연결되는 메일 안내를 제공합니다. 상황에 맞는 항목을 선택해 주세요.
          </p>
        </div>
